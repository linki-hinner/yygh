package com.lin.yygh.user.controller;
...
public class UserController {
    ...
    //用户列表（条件查询带分页）
    @GetMapping("/admin/user/{page}/{limit}")
    ...
    @GetMapping("/admin/user/lock/{userId}/{status}")
    public Result lock(
    ...
    @GetMapping("/admin/user/approval/{userId}/{authStatus}")
